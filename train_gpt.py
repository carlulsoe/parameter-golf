...
def main() -> None:
    ...
    if args.embed_beta2 != args.beta2 and not args.tie_embeddings:
        raise ValueError("EMBED_BETA2 requires TIE_EMBEDDINGS=1 so optimizer_tok matches the shared-matrix hypothesis")
    ...
    log0(
        ...
        f"{'tied_tok_emb_only' if args.tie_embeddings and token_beta2 != args.beta2 else 'baseline_all_groups'} "
