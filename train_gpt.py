...
def main() -> None:
    ...
    log0(
        f"optimizer_scalar:optimizer:{type(optimizer_scalar).__name__} "
        f"weight_decay:{args.scalar_weight_decay:.8f} "
        f"tensors:{scalar_tensor_count} numel:{scalar_param_numel}"
    )
    log0(
    ...
    log0(
        f"optimizer_scalar_final:optimizer:{type(optimizer_scalar).__name__} "
