...
def get_muon_momentum_schedule(applied_step: int, args: Hyperparameters) -> tuple[float, float]:
...
def main() -> None:
    ...
    initial_muon_momentum, initial_muon_warmup_fraction = get_muon_momentum_schedule(0, args)
    log0(
