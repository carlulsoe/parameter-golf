...
def main() -> None:
    ...
    args = Hyperparameters()
    if args.adam_eps <= 0.0 or args.embed_eps <= 0.0:
        raise ValueError(f"ADAM_EPS and EMBED_EPS must be positive, got ADAM_EPS={args.adam_eps} EMBED_EPS={args.embed_eps}")
