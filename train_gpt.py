...
def main() -> None:
    ...
    last_warmup_update = args.muon_momentum_warmup_steps - 1 if args.muon_momentum_warmup_steps > 0 else None
    ...
    log0(
        ...
        f"last_warmup_update:{last_warmup_update if last_warmup_update is not None else 'none'} "
