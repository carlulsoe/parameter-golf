...
def main() -> None:
    ...
    matrix_lr = args.matrix_lr * args.matrix_lr_mult
    ...
    log0(
        ...
        f"matrix_lr:{matrix_lr} matrix_baseline_lr:{args.matrix_lr} "
        f"matrix_lr_mult:{args.matrix_lr_mult} scalar_lr:{args.scalar_lr}"
    )
    log0(
    ...
    def log_optimizer_lr_groups(stage: str) -> None:
        ...
        log0(
            ...
            f"token_lr:{tok_group['lr']:.8f} token_base_lr:{tok_group['base_lr']:.8f} "
            f"matrix_lr:{muon_group['lr']:.8f} matrix_base_lr:{muon_group['base_lr']:.8f} "
            f"matrix_baseline_lr:{args.matrix_lr:.8f} matrix_lr_mult:{args.matrix_lr_mult:.8f} "
            f"scalar_lr:{scalar_group['lr']:.8f} scalar_base_lr:{scalar_group['base_lr']:.8f}"
        )
