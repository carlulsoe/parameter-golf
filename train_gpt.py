...
def main() -> None:
    ...
    log0(f"optimizer_scalar_group:tensors:{len(scalar_params)} numel:{scalar_numel}")
    ...
    log0(
        f"optimizer_scalar_final:tensors:{len(scalar_params)} numel:{scalar_numel} completed_updates:{step} "
