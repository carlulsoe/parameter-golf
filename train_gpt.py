...
def main() -> None:
    ...
    train_loader = DistributedTokenLoader(
        ...
        world_size,
        device,
        audit=TRAIN_STREAM_COVERAGE_AUDIT and rank == 0,
    )
    ...
    if TRAIN_STREAM_COVERAGE_AUDIT and master_process:
        sorted_live_exposure = train_loader.stream.audit_snapshot()
        shuffled_files = list(train_loader.stream.files)
        random.Random(TRAIN_STREAM_COVERAGE_AUDIT_SHUFFLE_SEED).shuffle(shuffled_files)
        ...
        log0(
            ...
            f"shuffle_seed:{TRAIN_STREAM_COVERAGE_AUDIT_SHUFFLE_SEED} "
