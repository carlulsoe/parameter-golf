...
def main() -> None:
    ...
    if not math.isfinite(args.scalar_lr_mult) or args.scalar_lr_mult <= 0:
        raise ValueError(f"SCALAR_LR_MULT must be finite and strictly positive, got {args.scalar_lr_mult}")
