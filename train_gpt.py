...
def main() -> None:
    ...
    scalar_param_tensor_count = len(scalar_params) + int(base_model.skip_weights.numel() > 0)
    scalar_param_numel = sum(int(p.numel()) for p in scalar_params) + int(base_model.skip_weights.numel())
    ...
    log0(
        f"optimizer_adam_config default_beta1:{args.beta1:.5f} scalar_beta1:{args.scalar_beta1:.5f} "
    ...
    def log_optimizer_beta_audit(stage: str) -> None:
        ...
        log0(
            ...
            f"scalar_tensors:{scalar_param_tensor_count} scalar_numel:{scalar_param_numel} "
