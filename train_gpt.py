...
def main() -> None:
    ...
    log0(
        ...
        f"adam_eps:{args.adam_eps:.8g} scalar_adam_eps:{args.scalar_adam_eps:.8g}"
    )
    log0(
        "scalar_adam_eps_scope:"
        f"optimizer_scalar_only scalar_param_tensors:{len(scalar_params)} "
