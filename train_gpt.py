...
class Hyperparameters:
    ...
    skip_weights_beta1 = float(os.environ.get("SKIP_WEIGHTS_BETA1", os.environ.get("BETA1", 0.9)))
...
def main() -> None:
    ...
    def log_optimizer_group_audit(stage: str) -> None:
        ...
        log0(
            ...
            f"skip_weights_beta1:{args.skip_weights_beta1:.5f} adam_eps:{args.adam_eps:.8f}"
        )
        log0(
