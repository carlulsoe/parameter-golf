...
class TokenStream:
    ...
    def __init__(self, pattern: str, seed: int = 0, shuffle_files: bool = False):
...
class DistributedTokenLoader:
    ...
    def __init__(
        ...
        self.device = device
        self.stream = TokenStream(pattern, seed=seed, shuffle_files=shuffle_files)
...
def main() -> None:
    ...
    log0(f"train_loader:shard_order:{'seed_shuffled' if args.shuffle_train_shards else 'sorted'}")
