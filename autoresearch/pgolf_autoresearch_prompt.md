...
- Prioritize ideas that can improve this 1xA40 proxy in a trustworthy way, with extra weight on mechanisms that are plausibly transferable to the full 8xH100 challenge regime. Deprioritize narrow one-off export bookkeeping tweaks unless repo evidence strongly supports them.
